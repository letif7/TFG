...
def isla_1(indicador_entrada_1,indicador_entrada_pos_1,nodo_terminal_1,act_prop,act_glob,best_fitness_1, best_execution_1, pdb_select_1, best_fitness_energ_1,best_execution_dist_1,a,b,MC_BB,corte,
           ...
           n_rep,tot_ececution,nodos_continuan_1,indicador_1,indicador_amino_1,M_ady_1,poblacion_1,prob_pob_1,model_3d,generacion):
    max_gdt_sal=0
    ...
    for i in range(n_pop):
        ...
        for j in det_fitness[i]:
            ...
            if local==1:
                ...
                prediction_3d=_request_esmfold_prediction(secuencia)
                PDB_pdredict = [prediction_3d]
...
def isla_2(indicador_entrada_2,indicador_entrada_pos_2,nodo_terminal_2,act_prop,act_glob,best_fitness_2, best_execution_2, pdb_select_2, best_fitness_energ_2,best_execution_dist_2,a,b,MC_BB,corte,
           descriptor_ref,my_scorefxn,p,det_fitness,BB,pos_min,tot_ececution_dist,fitness1,model,tokenizer,model_ESM2,desc_si_no,local,amino,n,n_fit,n_pop,
           n_rep,tot_ececution,nodos_continuan_2,indicador_2,indicador_amino_2,M_ady_2,poblacion_2,prob_pob_2,model_3d,generacion):
...
def isla_3(indicador_entrada_3,indicador_entrada_pos_3,nodo_terminal_3,act_prop,act_glob,best_fitness_3, best_execution_3, pdb_select_3, best_fitness_energ_3,best_execution_dist_3,a,b,MC_BB,corte,
           descriptor_ref,my_scorefxn,p,det_fitness,BB,pos_min,tot_ececution_dist,fitness1,model,tokenizer,model_ESM2,desc_si_no,local,amino,n,n_fit,n_pop,
           n_rep,tot_ececution,nodos_continuan_3,indicador_3,indicador_amino_3,M_ady_3,poblacion_3,prob_pob_3,model_3d,generacion):
    max_gdt_sal=0
    "i sera el individuo de la poblacion que se esta trabajando"
    for i in range(n_pop):
        "realiza las ejecuciones para el individuo de la poblacion"
...
def isla_4(indicador_entrada_4,indicador_entrada_pos_4,nodo_terminal_4,act_prop,act_glob,best_fitness_4, best_execution_4, pdb_select_4, best_fitness_energ_4,best_execution_dist_4,a,b,MC_BB,corte,
           descriptor_ref,my_scorefxn,p,det_fitness,BB,pos_min,tot_ececution_dist,fitness1,model,tokenizer,model_ESM2,desc_si_no,local,amino,n,n_fit,n_pop,
           n_rep,tot_ececution,nodos_continuan_4,indicador_4,indicador_amino_4,M_ady_4,poblacion_4,prob_pob_4,model_3d,generacion):
    "para utilizar en las actualizaciones"
...
def isla_9(indicador_entrada_9,indicador_entrada_pos_9,nodo_terminal_9,act_prop,act_glob,best_fitness_9, best_execution_9, pdb_select_9, best_fitness_energ_9,best_execution_dist_9,a,b,MC_BB,corte,
           descriptor_ref,my_scorefxn,p,det_fitness,BB,pos_min,tot_ececution_dist,fitness1,model,tokenizer,model_ESM2,desc_si_no,local,amino,n,n_fit,n_pop,
           n_rep,tot_ececution,nodos_continuan_9,indicador_9,indicador_amino_9,M_ady_9,poblacion_9,prob_pob_9,model_3d,generacion):
    max_gdt_sal=0
    "i sera el individuo de la poblacion que se esta trabajando"
    for i in range(n_pop):
        "realiza las ejecuciones para el individuo de la poblacion"
...
def isla_10(indicador_entrada_10,indicador_entrada_pos_10,nodo_terminal_10,act_prop,act_glob,best_fitness_10, best_execution_10, pdb_select_10, best_fitness_energ_10,best_execution_dist_10,a,b,MC_BB,corte,
           descriptor_ref,my_scorefxn,p,det_fitness,BB,pos_min,tot_ececution_dist,fitness1,model,tokenizer,model_ESM2,desc_si_no,local,amino,n,n_fit,n_pop,
           n_rep,tot_ececution,nodos_continuan_10,indicador_10,indicador_amino_10,M_ady_10,poblacion_10,prob_pob_10,model_3d,generacion):
    "para utilizar en las actualizaciones"
...
def isla_13(indicador_entrada_13,indicador_entrada_pos_13,nodo_terminal_13,act_prop,act_glob,best_fitness_13, best_execution_13, pdb_select_13, best_fitness_energ_13,best_execution_dist_13,a,b,MC_BB,corte,
           descriptor_ref,my_scorefxn,p,det_fitness,BB,pos_min,tot_ececution_dist,fitness1,model,tokenizer,model_ESM2,desc_si_no,local,amino,n,n_fit,n_pop,
           n_rep,tot_ececution,nodos_continuan_13,indicador_13,indicador_amino_13,M_ady_13,poblacion_13,prob_pob_13,model_3d,generacion):
    max_gdt_sal=0
    "i sera el individuo de la poblacion que se esta trabajando"
    for i in range(n_pop):
        "realiza las ejecuciones para el individuo de la poblacion"
...
def isla_14(indicador_entrada_14,indicador_entrada_pos_14,nodo_terminal_14,act_prop,act_glob,best_fitness_14, best_execution_14, pdb_select_14, best_fitness_energ_14,best_execution_dist_14,a,b,MC_BB,corte,
           descriptor_ref,my_scorefxn,p,det_fitness,BB,pos_min,tot_ececution_dist,fitness1,model,tokenizer,model_ESM2,desc_si_no,local,amino,n,n_fit,n_pop,
           n_rep,tot_ececution,nodos_continuan_14,indicador_14,indicador_amino_14,M_ady_14,poblacion_14,prob_pob_14,model_3d,generacion):
    "para utilizar en las actualizaciones"
...
def isla_17(utt_reinicio1,best_fitness_17, best_execution_17, pdb_select_17, best_fitness_energ_17,best_execution_dist_17,a,b,MC_BB,corte,
           ...
           n_rep,tot_ececution,prob_pob_17,det_fitness,model_3d,generacion):
    max_gdt_sal=0
    "i sera el individuo de la poblacion que se esta trabajando"
    for i in range(n_pop):
        "realiza las ejecuciones para el individuo de la poblacion"
...
def isla_18(utt_reinicio1,best_fitness_18, best_execution_18, pdb_select_18, best_fitness_energ_18,best_execution_dist_18,a,b,MC_BB,corte,
           descriptor_ref,my_scorefxn,p,BB,pos_min,tot_ececution_dist,fitness1,model,tokenizer,model_ESM2,desc_si_no,local,amino,n,n_fit,n_pop,
           n_rep,tot_ececution,prob_pob_18,det_fitness,model_3d,generacion):
    max_gdt_sal=0
    "i sera el individuo de la poblacion que se esta trabajando"
    for i in range(n_pop):
        "realiza las ejecuciones para el individuo de la poblacion"
...
def isla_19(utt_reinicio1,best_fitness_19, best_execution_19, pdb_select_19, best_fitness_energ_19,best_execution_dist_19,a,b,MC_BB,corte,
           descriptor_ref,my_scorefxn,p,BB,pos_min,tot_ececution_dist,fitness1,model,tokenizer,model_ESM2,desc_si_no,local,amino,n,n_fit,n_pop,
           n_rep,tot_ececution,prob_pob_19,det_fitness,model_3d,generacion):
    max_gdt_sal=0
    "i sera el individuo de la poblacion que se esta trabajando"
    for i in range(n_pop):
        "realiza las ejecuciones para el individuo de la poblacion"
...
def isla_20(utt_reinicio1,best_fitness_20, best_execution_20, pdb_select_20, best_fitness_energ_20,best_execution_dist_20,a,b,MC_BB,corte,
           descriptor_ref,my_scorefxn,p,BB,pos_min,tot_ececution_dist,fitness1,model,tokenizer,model_ESM2,desc_si_no,local,amino,n,n_fit,n_pop,
           n_rep,tot_ececution,prob_pob_20,det_fitness,model_3d,generacion):
    max_gdt_sal=0
    "i sera el individuo de la poblacion que se esta trabajando"
    for i in range(n_pop):
        "realiza las ejecuciones para el individuo de la poblacion"
...
def inicializa_isla_21(n,n_pop,amino,n_best):
    global best_execution_21
    global best_execution_dist_21
    global pdb_select_21
    global best_fitness_21
    global best_fitness_energ_21
    n_pop1=100
    best_fitness_21=[0]*n_best
    "almacena los valores de energia"
    best_fitness_energ_21=[20000]*n_best
    "almacena las n_best mejores ejecuciones"
    "best_execution = [[random.randint(0, 19) for _ in range(n)] for _ in range(n_best)]"
    best_execution_21 = [[0 for _ in range(n)] for _ in range(n_best)]
    
    "almacena las distancias de las n_best mejores ejecuciones"
    best_execution_dist_21 = [[0 for _ in range(n)] for _ in range(n_best)]
    "almacena los PDB de las n_best mejores ejecuciones"
    pdb_select_21 = ['a' for _ in range(n_best)]
    poblacion_21 =[[random.randint(0, 19) for _ in range(n)] for _ in range(n_pop1)]
    pob_fitness_21=[0.1 for _ in range(n_pop1)]
    return best_fitness_21,best_fitness_energ_21,best_execution_21,best_execution_dist_21,pdb_select_21,poblacion_21,pob_fitness_21,n_pop1
    

#indicador_entrada_21,indicador_entrada_pos_21,nodo_terminal_21,act_prop,act_glob,best_fitness_21, best_execution_21, pdb_select_21, best_fitness_energ_21,best_execution_dist_21,a,b,MC_BB,corte,
 #          descriptor_ref,my_scorefxn,p,det_fitness,BB,pos_min,tot_ececution_dist,fitness1,model,tokenizer,model_ESM2,desc_si_no,local,amino,n,n_fit,n_pop,n_pop1
 #          n_rep,tot_ececution,nodos_continuan_21,indicador_21,indicador_amino_21,M_ady_21,poblacion_21,prob_pob_21,pob_fitness_21,model_3d,generacion


def isla_21(best_fitness_21,best_fitness_energ_21,best_execution_21,best_execution_dist_21,pdb_select_21,poblacion_21,pob_fitness_21,n_pop1,p_muta,n,
            corte,amino,desc_si_no,tokenizer,model_ESM2,local,model,model_3d,p,my_scorefxn,MC_BB,BB,descriptor_ref,a,b,pos_min,generacion,n_pop,n_rep):
    max_gdt_sal=0
    p_cruza=n_pop*n_rep/n_pop1
    "i sera el individuo de la poblacion que se esta trabajando"
    if generacion==0:
        for i in range(n_pop1):
            print([i,i])
            "ejecucion j del elemento i de la poblacion a trabajar"
            posiciones_seq =poblacion_21[i]
            "Secuencia de aminoacidos de la ejecucion"
            #print(hijo[j])
            secuencia = det_sec(posiciones_seq, amino)
            "PDB de la secuencia"
            ...
            if desc_si_no==1:
                ...
                print([rms,gdt,energia_desing,MC_similitud,np.mean(divKl)])
                "se agregan los valores"
                fitness21_temp=agrega_rmsd_gdt_E_MC_divKl(MC_similitud,energia_desing,rms,gdt,divKl,a,b,tms)
            else:
                rms,gdt,MC_similitud,distancias_sal,tms=fitness_gdt_rmsd_mc(BB, back_temp,MC_BB,corte)
                print([rms,gdt,energia_desing,MC_similitud])
                fitness21_temp=agrega_rmsd_gdt_E_MC(MC_similitud,energia_desing,rms,gdt,a,b,tms)  
            pob_fitness_21[i]=fitness21_temp

            "si la ejecucion tiene mayor fitnes que alguno en best_fitness entonces se actualiza la lista de los mejores"
            if fitness21_temp>best_fitness_21[pos_min]:
                best_fitness_21[pos_min]=fitness21_temp
                best_fitness_energ_21[pos_min]=[energia_desing,21,copy.deepcopy(generacion)]
                best_execution_21[pos_min]=copy.deepcopy(poblacion_21[i])
                pdb_select_21[pos_min] = PDB_pdredict[0][:]
                best_execution_dist_21[pos_min]=distancias_sal
                best_fitness_21, best_execution_21, pdb_select_21, best_fitness_energ_21,best_execution_dist_21=ordena_mejores_energia(best_fitness_21, best_execution_21, pdb_select_21, best_fitness_energ_21,best_execution_dist_21)
                max_gdt_sal=max(max_gdt_sal,gdt)
    else:
        total_fitness = sum(pob_fitness_21)
        probabilidades = [iji / total_fitness for iji in pob_fitness_21]
        muestra = np.random.choice(list(range(n_pop1)), size=n_pop1,p=probabilidades,replace=True)
        muestra = [int(i) for i in muestra]
        cambia=[0]*n_pop1
        poblacion_21_temp_temp =copy.deepcopy(poblacion_21)
        pob_fitness_21_temp_temp=copy.deepcopy(pob_fitness_21)
        for i in range(int(n_pop1/2)):
            temporal3=random.random()
            if temporal3>p_cruza:
                poblacion_21[2*i]=copy.deepcopy(poblacion_21_temp_temp[muestra[2*i]])  
                poblacion_21[2*i+1]=copy.deepcopy(poblacion_21_temp_temp[muestra[2*i+1]]) 
                pob_fitness_21[2*i]=copy.deepcopy(pob_fitness_21_temp_temp[muestra[2*i]])  
                pob_fitness_21[2*i+1]=copy.deepcopy(pob_fitness_21_temp_temp[muestra[2*i+1]])  
            else:
                cambia[2*i]=1
                cambia[2*i+1]=1
                temporal1=poblacion_21_temp_temp[muestra[2*i]]
                temporal2=poblacion_21_temp_temp[muestra[2*i+1]]
                temporal3=random.randint(1, n-2)
                hijo1=temporal1[:temporal3]
                hijo1.extend(temporal2[temporal3:])
                hijo2=temporal2[:temporal3]
                hijo2.extend(temporal1[temporal3:])
                temporal3=random.random()
                if temporal3<p_muta:
                    hijo1[random.randint(0, n-1)]=random.randint(0, 19)
                temporal3=random.random()
                if temporal3<p_muta:
                    hijo2[random.randint(0, n-1)]=random.randint(0, 19)
                poblacion_21[2*i]=copy.deepcopy(hijo1)
                poblacion_21[2*i+1]=copy.deepcopy(hijo2)
        for i in range(n_pop1):
            if cambia[i]==1:
                print([i,i])
                "ejecucion j del elemento i de la poblacion a trabajar"
                ...
                if fitness21_temp>best_fitness_21[pos_min]:
                    ...
                    best_fitness_21, best_execution_21, pdb_select_21, best_fitness_energ_21,best_execution_dist_21=ordena_mejores_energia(best_fitness_21, best_execution_21, pdb_select_21, best_fitness_energ_21,best_execution_dist_21)
                    max_gdt_sal=max(max_gdt_sal,gdt)
    return max_gdt_sal,best_fitness_21, best_execution_21, pdb_select_21, best_fitness_energ_21,best_execution_dist_21,poblacion_21,pob_fitness_21
