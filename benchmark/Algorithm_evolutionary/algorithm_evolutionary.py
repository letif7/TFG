...
from ..islas.islas import inicializa_isla_11,isla_11,inicializa_isla_12,isla_12,inicializa_isla_13,isla_13,inicializa_isla_14,isla_14,inicializa_isla_15,inicializa_isla_21
from ..islas.islas import isla_15,inicializa_isla_16,isla_16,inicializa_isla_17,isla_17,inicializa_isla_18,isla_18,isla_21
...
def EDA_isla(pdb_file_path,desc_si_no,continua,numnum,n_pop,n_rep,n_fit,act_prop,act_glob,n_best,pos_min,n_generaciones,
    ...
    model_3d=_request_esmfold_prediction
    max_gdt_global=0
    "cada aminoacido en amino se hace coincidir con su correspondiente numero en"
    num_amino = list(range(0, 20))
    "secuencia del peptido, si procede"
    ...
    if 21 in islas:
        best_fitness_21,best_fitness_energ_21,best_execution_21,best_execution_dist_21,pdb_select_21,poblacion_21,pob_fitness_21,n_pop1=inicializa_isla_21(n,n_pop,amino,n_best)
    ...
    if continua==1:
        ...
        with open(ruta_archivo, "r") as archivo:
            for linea in archivo:
                ...
                elif etiqueta == "best_execution_21":
                    best_execution_21= eval(valor)
                elif etiqueta == "best_execution_dist_21":
                    best_execution_dist_21 = eval(valor)            
                elif etiqueta == "best_fitness_21":
                    best_fitness_21 = eval(valor)
                elif etiqueta == "poblacion_21":
                    poblacion_21 = eval(valor)
                elif etiqueta == "best_fitness_energ_21":
                    best_fitness_energ_21= eval(valor)
                elif etiqueta == "pdb_select_21":
                    pdb_select_21= eval(valor)
                elif etiqueta == "pob_fitness_21":
                    pob_fitness_21= eval(valor)
        generacion=numnum
    ...
    while generacion<n_generaciones and max_gdt_global<max_gdt:
        ...
        if 17 in islas or 18 in islas:
            ...
            all_best_execution1 =pd.DataFrame(all_best_execution)
            all_best_execution1=all_best_execution1.drop_duplicates()
            all_best_execution=all_best_execution1.values.tolist()
            if len(all_best_execution)<tot_act_red:
                tot_act_red1=len(all_best_execution)-10
            else:
                tot_act_red1=tot_act_red
            if 17 in islas:
                #print(all_best_execution)
                #print(tot_act_red1)
                poblacion_17=actualiza_individuo_red(poblacion_17,all_best_execution,tot_act_red1,n)
            ...
            if 18 in islas:
                if generacion in utt_reinicio1:
                    ...
                    poblacion_18=actualiza_individuo_red(poblacion_18,all_best_execution,tot_act_red1,n)
                    ...
                    for iikkpp in range(1,len(prob_pob_18)):
                        prob_pob_18[iikkpp]=prob_pob_18[0]
            if 19 in islas:
                poblacion_19=actualiza_individuo_red(poblacion_19,all_best_execution,tot_act_red1,n)
            ...
            if 20 in islas:
                if generacion in utt_reinicio1:
                    ...
                    poblacion_20=actualiza_individuo_red(poblacion_20,all_best_execution,tot_act_red1,n)
        ...
        if 21 in islas:
            print([21,generacion])
            print(poblacion_21)
            max_gdt_sal_21,best_fitness_21, best_execution_21, pdb_select_21, best_fitness_energ_21,best_execution_dist_21,poblacion_21,pob_fitness_21=isla_21(best_fitness_21,best_fitness_energ_21,best_execution_21,best_execution_dist_21,pdb_select_21,poblacion_21,pob_fitness_21,n_pop1,p_muta,n,
        ...
        if generacion in uutt or max_gdt<=max_gdt_global:
            ...
            with open(ruta_archivo, 'w') as archivo:
                ...
                if 21 in islas:
                    archivo.write(f"best_execution_21: {best_execution_21}\n")
                    archivo.write(f"best_execution_dist_21: {best_execution_dist_21}\n")
                    archivo.write(f"best_fitness_21: {best_fitness_21}\n")
                    archivo.write(f"pdb_select_21: {pdb_select_21}\n")
                    archivo.write(f"poblacion_21: {poblacion_21}\n")
                    archivo.write(f"best_fitness_energ_21: {best_fitness_energ_21}\n") 
                    archivo.write(f"pob_fitness_21: {pob_fitness_21}\n")

        #print(best_execution_21)
