...
from ..getDstructure.get_structure import _request_esmfold_prediction,parse_output,get_hash,genera,_request_esmfold_prediction
import pyrosetta
import numpy as np
    ...
    for i in range(n_pop):
        ...
        for j in det_fitness[i]:
            ...
            if fitness1[i][k]>best_fitness_1[pos_min]:
                ...
                best_fitness_energ_1[pos_min]=energia_desing
    ...
    for i in range(n_pop):
        ...
        for j in det_fitness[i]:
            ...
            if fitness1[i][k]>best_fitness_2[pos_min]:
                ...
                best_fitness_energ_2[pos_min]=energia_desing
    ...
    for i in range(n_pop):
        ...
        for j in det_fitness[i]:
            ...
            if fitness1[i][k]>best_fitness_3[pos_min]:
                ...
                best_fitness_energ_3[pos_min]=energia_desing
    ...
    for i in range(n_pop):
        ...
        for j in det_fitness[i]:
            ...
            if fitness1[i][k]>best_fitness_4[pos_min]:
                ...
                best_fitness_energ_4[pos_min]=energia_desing
    ...
    for i in range(n_pop):
        ...
        for j in det_fitness[i]:
            ...
            if fitness1[i][k]>best_fitness_5[pos_min]:
                ...
                best_fitness_energ_5[pos_min]=energia_desing
    ...
    for i in range(n_pop):
        ...
        for j in det_fitness[i]:
            ...
            if fitness1[i][k]>best_fitness_6[pos_min]:
                ...
                best_fitness_energ_6[pos_min]=energia_desing
    ...
    for i in range(n_pop):
        ...
        for j in det_fitness[i]:
            ...
            if fitness1[i][k]>best_fitness_7[pos_min]:
                ...
                best_fitness_energ_7[pos_min]=energia_desing
    ...
    for i in range(n_pop):
        ...
        for j in det_fitness[i]:
            ...
            if fitness1[i][k]>best_fitness_8[pos_min]:
                ...
                best_fitness_energ_8[pos_min]=energia_desing
    ...
    for i in range(n_pop):
        ...
        for j in det_fitness[i]:
            ...
            if fitness1[i][k]>best_fitness_9[pos_min]:
                ...
                best_fitness_energ_9[pos_min]=energia_desing
    ...
    for i in range(n_pop):
        ...
        for j in det_fitness[i]:
            ...
            if fitness1[i][k]>best_fitness_10[pos_min]:
                ...
                best_fitness_energ_10[pos_min]=energia_desing
    ...
    for i in range(n_pop):
        ...
        for j in det_fitness[i]:
            ...
            if fitness1[i][k]>best_fitness_11[pos_min]:
                ...
                best_fitness_energ_11[pos_min]=energia_desing
    ...
    for i in range(n_pop):
        ...
        for j in det_fitness[i]:
            ...
            if fitness1[i][k]>best_fitness_12[pos_min]:
                ...
                best_fitness_energ_12[pos_min]=energia_desing
    ...
    for i in range(n_pop):
        ...
        for j in det_fitness[i]:
            ...
            if fitness1[i][k]>best_fitness_13[pos_min]:
                ...
                best_fitness_energ_13[pos_min]=energia_desing
    ...
    for i in range(n_pop):
        ...
        for j in det_fitness[i]:
            ...
            if fitness1[i][k]>best_fitness_14[pos_min]:
                ...
                best_fitness_energ_14[pos_min]=energia_desing
    ...
    for i in range(n_pop):
        ...
        for j in det_fitness[i]:
            ...
            if fitness1[i][k]>best_fitness_15[pos_min]:
                ...
                best_fitness_energ_15[pos_min]=energia_desing
    ...
    for i in range(n_pop):
        ...
        for j in det_fitness[i]:
            ...
            if fitness1[i][k]>best_fitness_16[pos_min]:
                ...
                best_fitness_energ_16[pos_min]=energia_desing
    ...
    for i in range(n_pop):
        ...
        for j in det_fitness[i]:
            ...
            if fitness1[i][k]>best_fitness_17[pos_min]:
                ...
                best_fitness_energ_17[pos_min]=energia_desing
    ...
    for i in range(n_pop):
        ...
        for j in det_fitness[i]:
            ...
            if fitness1[i][k]>best_fitness_18[pos_min]:
                ...
                best_fitness_energ_18[pos_min]=energia_desing
    ...
    for i in range(n_pop):
        ...
        for j in det_fitness[i]:
            ...
            if fitness1[i][k]>best_fitness_19[pos_min]:
                ...
                best_fitness_energ_19[pos_min]=energia_desing
    ...
    for i in range(n_pop):
        ...
        for j in det_fitness[i]:
            ...
            if fitness1[i][k]>best_fitness_20[pos_min]:
                ...
                best_fitness_energ_20[pos_min]=energia_desing
